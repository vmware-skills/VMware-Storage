...
Family fix from an external fork report (VMware-AIops PR #32, 2026-07).
Storage already used the correct bare ``except Exception`` probe (pinned here
to keep it that way), but shared the second dead-session shape with the rest
of the family:
