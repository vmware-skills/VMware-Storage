...
from vmware_storage.config import TargetConfig
from vmware_storage.connection import ConnectionManager, _release_si
...
def _password(monkeypatch):
    ...
    monkeypatch.setenv("VMWARE_STORAGE_VCENTER_PROD_PASSWORD", "test-only")
