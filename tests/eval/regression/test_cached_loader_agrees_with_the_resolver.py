...
``VMWARE_STORAGE_CONFIG``, then ``CONFIG_FILE`` — was consolidated into
...
from vmware_storage.config import CONFIG_FILE, resolve_config_path

_ENV = "VMWARE_STORAGE_CONFIG"
