...
PROPERTY_CHAINS = [
    ...
    # FC / multipath reads (VMware-Storage#18)
    ("HostSystem", "config.storageDevice.hostBusAdapter"),
    ("HostSystem", "config.storageDevice.scsiLun"),
    ("HostSystem", "config.storageDevice.multipathInfo.lun.path.transport"),
    ("HostSystem", "config.storageDevice.multipathInfo.lun.path.isWorkingPath"),
    ("HostSystem", "config.storageDevice.multipathInfo.lun.policy.policy"),
    ("HostSystem", "config.storageDevice.multipathInfo.lun.storageArrayTypePolicy.policy"),
    ("HostSystem", "config.fileSystemVolume.mountInfo.volume"),
    ("host.FibreChannelHba", "portWorldWideName"),
    ("host.FibreChannelHba", "nodeWorldWideName"),
    ("host.FibreChannelHba", "portType"),
    ("host.FibreChannelHba", "speed"),
    ("host.FibreChannelTargetTransport", "portWorldWideName"),
    ("host.InternetScsiTargetTransport", "iScsiName"),
    ("host.ScsiDisk", "localDisk"),
    ("host.VmfsVolume", "extent.diskName"),
    ("host.VmfsVolume", "uuid"),
