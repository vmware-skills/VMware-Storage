...
| **[vmware-monitor](https://github.com/zw008/VMware-Monitor)**（只读） | 只读监控、告警、事件、VM 信息 | 27 | `uv tool install vmware-monitor` |
...
`vmware-aiops` 有 49 个 MCP 工具——对本地小模型（7B-14B）来说上下文占用太重。独立拆分后：
